  ...
  return (
    <div className="min-h-screen bg-[#12131C] p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-4 border-white/50 overflow-hidden">
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute bottom-4 left-6">
              <div className="text-white text-4xl font-black drop-shadow-lg">{currentVerb.infinitive.toUpperCase()}</div>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2 p-4 bg-gray-50 rounded-2xl border-2 border-gray-200 min-h-14">
            ...
            {/* Feedback */}
            {showFeedback && (
              <div className={`mt-4 p-5 rounded-2xl border-4 ${isCorrect ? 'bg-green-100 border-green-400' : 'bg-red-100 border-red-400'}`}>
        ...
        {/* Progress Bar */}
        <div className="mt-6 bg-[#1C1E2B] rounded-2xl p-5 border-2 border-white/10">
          <div className="flex justify-between mb-2">
            <span className="text-white font-bold">Progress</span>
            <span className="text-white font-bold">{Math.round(((currentIndex + 1) / verbs.length) * 100)}%</span>
          </div>
          <div className="w-full h-4 bg-[#12131C] rounded-full overflow-hidden border-2 border-white/10">
            <div
