...
export default function FlashCards() {
  ...
  if (showComplete) {
    const successRate = sessionStats.attempts > 0
        ...
        <div className="max-w-2xl w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-12 border-4 border-white/50 text-center">
            ...
            <div className="mb-8 bg-[#6FCF97]/10 rounded-2xl p-5 border-2 border-[#6FCF97]/30">
              ...
              <div className="w-full h-4 bg-white rounded-full overflow-hidden border-2 border-[#6FCF97]/20">
                <div
                  ...
                  style={{ width: `${(masteredThisSession / verbs.length) * 100}%` }}
                />
              </div>
            </div>
            ...
            <div className="text-lg font-bold text-gray-600 mb-8">
              ...
              {successRate >= 50 && successRate < 80 && "Good job! You're getting there. 🌟"}
              {successRate >= 80 && "Outstanding! You're mastering these verbs. 🎉"}
            </div>

            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={() => { setShowComplete(false); setCurrentIndex(0); setUserAnswer(''); setShowFeedback(false); setIsCorrect(false); setSessionStats({ correct: 0, attempts: 0 }); }}
  ...
  return (
    <div className="min-h-screen bg-[#12131C] p-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main Card */}
        <div className="bg-white rounded-3xl shadow-2xl p-12 border-4 border-white/50">
          {/* Image */}
          <div className="mb-8">
            <div className="relative w-full h-96 rounded-3xl overflow-hidden border-4 border-purple-200 shadow-xl">
              <img
          ...
          <div className="mb-8">
            ...
            <input
              ...
              className="w-full text-3xl font-bold px-8 py-6 border-4 border-purple-300 rounded-2xl focus:outline-none focus:border-purple-500 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed text-black"
            />
          </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div className="text-lg text-green-600">
                        The answer is: <span className="font-bold">{currentVerb.infinitive}</span>
                      </div>
                    </div>
                  </>
                ) : (
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <button
              ...
              className="bg-[#1C1E2B] hover:bg-[#2A2D3E] text-white font-black text-xl py-6 rounded-2xl border-4 border-white/10 hover:border-[#6FCF97] shadow-lg hover:shadow-xl transform hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none"
            >
            ...
            <button
              ...
              className="bg-[#6FCF97] hover:bg-[#5EBF87] text-[#12131C] font-black text-xl py-6 rounded-2xl border-4 border-[#6FCF97]/30 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
            ...
            <button
              onClick={handleNext}
              disabled={!showFeedback}
              className="bg-[#1C1E2B] hover:bg-[#2A2D3E] text-white font-black text-xl py-6 rounded-2xl border-4 border-white/10 hover:border-[#6FCF97] shadow-lg hover:shadow-xl transform hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
              NEXT
        ...
        <div className="mt-8 bg-[#1C1E2B] rounded-2xl p-6 border-2 border-white/10">
          <div className="flex justify-between mb-3">
            ...
            <span className="text-white font-bold text-lg">
              {Math.round(((currentIndex + 1) / verbs.length) * 100)}%
            </span>
          </div>
